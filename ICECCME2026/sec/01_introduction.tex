...
Beyond pure NLP serving, this deployment constraint is also relevant to
mechatronic and cyber-physical workflows that require low-latency local
language interaction, including edge-side instruction parsing, operator
assistance, and offline diagnostics. We therefore position this paper as a
hardware-aware characterization study for local intelligent systems, not as a
...
\begin{enumerate}\itemsep0pt
  \item[\textbf{RQ1.}] How much end-to-end speedup does vanilla
        ...
        single RTX~4090 Laptop with a 3\,B target, and how close is this to
...
\begin{enumerate}\itemsep0pt
  ...
  \item A practical operating recommendation and a transparent statement of
        ...
        together with adaptive-policy design guidance derived from these
        fixed-policy observations.
\end{enumerate}
...
an adaptive speculative-strategy discussion derived from the observed
$k$-efficiency inflection. Section~\ref{sec:discussion}
