...
including laptop assistants and edge-side decision-support workflows. We
...
\begin{enumerate}\itemsep0pt
  ...
  \item A practical operating recommendation and a transparent statement of
        ...
        together with adaptive-policy design guidance and an ACSD
        quantitative validation on the same manifests.
\end{enumerate}
