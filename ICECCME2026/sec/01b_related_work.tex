...
Recent cascaded work includes CAS-Spec~\cite{Wang2025CASSpec}, which focuses
on self-speculation routing and sparsity-aware intra-model control, and
Speculative Cascades, which combines model-cascades with speculative decoding
in a hybrid serving architecture. In
contrast, ACSD here is a training-free online controller between independent
same-family draft models (0.5B and 1.5B), designed for consumer-hardware
runtime stability rather than new drafter training or routing-tree learning.
...
operating points on a single RTX~4090, including acceptance dynamics,
