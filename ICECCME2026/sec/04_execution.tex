...
guarantee end-to-end latency gains under all runtime conditions. This is why
we report both absolute speedup and component-level timing rather than
assuming graph capture alone explains throughput behavior.
