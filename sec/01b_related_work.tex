...
operating points on a single RTX~5090, including acceptance dynamics,
quality drift, and runtime-sensitive configuration choices. We then use these
results to motivate a future parallel-drafter extension (DriftDiffuse) aimed
at reducing linear-in-$k$ drafting cost under the same hardware budget.
