...
\begin{enumerate}\itemsep0pt
  \item[\textbf{RQ1.}] How much end-to-end speedup does vanilla
        ...
        single RTX~5090 Laptop with a 3\,B target?
...
\begin{enumerate}\itemsep0pt
  ...
  \item Empirical evidence of a non-monotonic $k$ effect, with highest observed
        performance at 1.5B, $k{=}8$, deterministic ($S{=}1.7289$), and
        higher deterministic mean speedup than stochastic decoding across all
        matched draft--$k$ pairs in the current run family.
