...
All results are from one RTX~5090 Laptop. Relative rankings are informative for this
...
extend this baseline with ACSD (Section~\ref{sec:acsd}) under the same
...
control. ACSD remains prospective in the present manuscript and is not part of
the quantitative results section.
