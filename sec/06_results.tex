...
reported by the summary artifact; CI$_S$ denotes paired bootstrap CI status;
...
1.5B, $k{=}8$, det   & \textbf{1.7289} & planned & 0.3829 & 2.96 & -1.00 & 0.60 & -0.37 & 12.80 \\
...
All 12 speculative configurations exceed $S{=}1$ in the current summary,
with observed speedups
...
workload and prompts. Statistical confirmation is reported via paired
uncertainty analysis on a coherent run family.
