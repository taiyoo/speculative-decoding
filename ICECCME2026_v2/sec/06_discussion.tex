...
per-sample dispersion within a single evaluation seed, not run-to-run
variability across independent seeds. Independent multi-seed repetition of
full runs was not performed and is left for future work.
