...
\subsection{Sample-level dispersion, TTFT/TPOT, and statistical testing detail}
...
single-seed) alongside the ratio-of-means speedup in
...
mix and output-length differences) within a single seed rather than
run-to-run measurement noise; independent multi-seed repetition of full
runs is noted as a remaining limitation in Section~\ref{sec:threats}.
...
mean speedup ($S{=}0.9719$) reported above.
